...
| 🤖 **InternINDIA AI** | Built an AI-driven internship recommendation system processing 500+ user inputs. Developed and deployed 8+ REST APIs for authentication and internship retrieval, improved recommendation accuracy using machine learning-based matching, and optimized backend architecture to reduce response latency by 25%. | Python · Machine Learning · REST APIs · Backend Development | [Website](https://intern-india-ai.netlify.app/) |
