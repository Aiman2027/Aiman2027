<h1 align="center">Hi 👋, I'm Aiman Nishat</h1>
...
| 📊 **alcovia-app** | Offline-first study app for grades 6–12 featuring focus sessions, syllabus progress tracking, multi-device synchronization, conflict resolution using Lamport clocks, streaks & rewards, and n8n-powered automation. Built with React Native (Expo), Express, TypeScript, AsyncStorage, and webhook-based workflows. | React Native · Expo · TypeScript · Express · n8n · AsyncStorage |[Repo](https://github.com/Aiman2027/alcovia) |
| 🤖 **InternINDIA AI** | Collaborated with a development team to build an AI-powered internship recommendation platform processing 500+ user inputs. Contributed to the development and deployment of 8+ REST APIs for authentication and internship retrieval, helped improve recommendation accuracy through machine learning-based matching logic, and assisted in optimizing backend performance to reduce response latency by 25%. | Python · Machine Learning · REST APIs · Backend Development | [Website](https://intern-india-ai.netlify.app/) |
| 🤖 **Mirai AI Builder Internship** | A collection of projects and assignments completed during the **MirAI School of Technology – Virtual Summer Internship 2026 (AI Builder Track)**. Built interactive AI applications using **Python, Streamlit, and the Google Gemini API**, including calculators, chatbot interfaces, prompt engineering exercises, and AI-powered web apps. | Python · Streamlit · Google Gemini API · Prompt Engineering | [Repo](https://github.com/Aiman2027/mirai-ai-builder-internship) |

---

### 🏆 Achievements

- 🌟 **Google Student Ambassador** — Driving AI awareness across Bihar campuses
- 🎖️ **Microsoft Learn Student Ambassador** — 1 year | One of ~3,000 globally
- ⚡ **LeetCode 1500+** Rating
- 🏅 **SIH Internal Hackathon** — Cleared internal college round
- 👨‍💼 **Team Leader** — Led development team at CDAC Patna
